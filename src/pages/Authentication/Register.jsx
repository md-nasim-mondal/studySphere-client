      ...
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-xl'>
        <div className='w-full px-6 py-8 md:px-8'>
            ...
            <div className='mt-4 relative'>
              ...
              <span
                ...
                {showPassword ? (
                  ...
                  <FaEyeSlash className='text-blue-500'></FaEyeSlash>
                )}
              </span>
            </div>
            <div className='mt-6'>
          ...
          <div className='flex items-center justify-between mt-4'>
            ...
            <p className='text-xs text-gray-500 uppercase  hover:underline text-center'>
              Already have an account?
              <br />
              <Link
                to='/login'
                className='text-blue-500 font-semibold leading-8'>
                sign in
              </Link>
            </p>
